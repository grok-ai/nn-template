...
The basic funcitonalities are intuitive: it is enough to change the files in `conf/*` accordingly to your preferences. Everyting will be logged in `wandb` automatically.
